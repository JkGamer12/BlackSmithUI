...
namespace JkGamer12\BlackSmith;
...
public function rruiform(Player $sender){
    ...
    $form->addButton("§l§6REPAIR\n§l§9»» §r§oTap to Repair", 0, "textures/ui/op");
    $form->addButton("§l§6RENAME\n§l§9»» §r§oTap to Rename", 0, "textures/ui/op");
    $form->addButton("§l§6LORE\n§l§9»» §r§oTap to Change", 0, "textures/ui/op");
...
public function menu(Player $sender){
    ...
    $form->setTitle(T::BOLD . T::GREEN . "BlackSmith");
